    ...
    public class HttpHostedJsonLocalizationExtensionServiceTest
    {
            ...
            string resourcePath)
        {
            ...
            using var httpClient = new HttpClientMockBuilder()
                ...
                .WithOkResponse(
                    "/_content/SoloX.BlazorJsonLocalization.UTests/Resources/HttpHostedJsonLocalizationExtensionServiceTest.json",
                    request => new StreamContent(new MemoryStream(Encoding.UTF8.GetBytes("{\"Test\": \"English test.\"}"))))
                .WithOkResponse(
                    "/_content/SoloX.BlazorJsonLocalization.UTests/Resources/HttpHostedJsonLocalizationExtensionServiceTest-fr.json",
