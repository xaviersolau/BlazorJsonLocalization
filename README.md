...
```bash
Install-Package SoloX.BlazorJsonLocalization -version 2.0.8
Install-Package SoloX.BlazorJsonLocalization.WebAssembly -version 2.0.8
Install-Package SoloX.BlazorJsonLocalization.ServerSide -version 2.0.8
```

**Install using the .Net CLI:**
```bash
dotnet add package SoloX.BlazorJsonLocalization --version 2.0.8
dotnet add package SoloX.BlazorJsonLocalization.WebAssembly --version 2.0.8
dotnet add package SoloX.BlazorJsonLocalization.ServerSide --version 2.0.8
```
