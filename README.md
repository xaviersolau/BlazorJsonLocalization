...
```bash
Install-Package SoloX.BlazorJsonLocalization -version 1.0.2-alpha.4
Install-Package SoloX.BlazorJsonLocalization.WebAssembly -version 1.0.2-alpha.4
Install-Package SoloX.BlazorJsonLocalization.ServerSide -version 1.0.2-alpha.4
```

**Install using the .Net CLI:**
```bash
dotnet add package SoloX.BlazorJsonLocalization --version 1.0.2-alpha.4
dotnet add package SoloX.BlazorJsonLocalization.WebAssembly --version 1.0.2-alpha.4
dotnet add package SoloX.BlazorJsonLocalization.ServerSide --version 1.0.2-alpha.4
```

**Install editing your project file (csproj):**
```xml
<PackageReference Include="SoloX.BlazorJsonLocalization" Version="1.0.2-alpha.4" />
<PackageReference Include="SoloX.BlazorJsonLocalization.WebAssembly" Version="1.0.2-alpha.4" />
<PackageReference Include="SoloX.BlazorJsonLocalization.ServerSide" Version="1.0.2-alpha.4" />
```
